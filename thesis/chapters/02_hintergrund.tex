...
Der Nachteil dieses Ansatzes liegt in der Komplexität: Die Anzahl der zu prüfenden Kombinationen wächst exponentiell mit der Problemgröße. Feldman und Golumbic nutzten Brute-Force in ihrer Arbeit von 1990 als Baseline, was für die dort betrachteten kleinen Probleminstanzen ("30 courses", was als 30 \textit{Offerings} interpretiert wurde \cite{feldmangolumbic}) praktikabel war. Für den WU-Datensatz dieser Arbeit mit 381 \textit{Offerings} und 28 \textit{Courses} wäre ein Brute-Force-Ansatz rechnerisch nicht mehr durchführbar --- die Anzahl möglicher Kombinationen übersteigt jede akzeptable Laufzeit bei weitem.

Die Frage, wie ein exaktes Verfahren dennoch für größere Probleminstanzen eingesetzt werden kann, beantwortet ein Ansatz, der seit den 1990er Jahren erheblich an praktischer Bedeutung gewonnen hat: Integer Linear Programming \cite{bixby2012brief} \cite{newman-2013}.
...
Die vorliegende Arbeit untersucht mit Hill-Climbing und Offering-Order zwei der grundlegendsten Vertreter von Greedy-Konstruktionsheuristiken und prüft, ob ihre Ergebnisse unter heutigen Bedingungen Bestand haben --- und ob ILP-Solver diese Heuristiken mittlerweile auch in der Laufzeit übertreffen.
...
In computergestützter Forschung wird unter Reproduzierbarkeit zusätlich die Möglichkeit verstanden, die Ergebnisse auf Basis der zugrunde liegenden Daten und Algorithmen exakt nachzuvollziehen.Sandve et al. formulierten hierfür zehn Prinzipen ("Ten Simple Rules for Reproducible Computational Research") \cite{sandve-2013}, die von der Dokumentation aller Auswertungsschritte bis zur öffentlichen Zugänglichkeit von Code und Ergebnissen reichen und so die Überprüfbarkeit sicherstellen.
