...
Zwar läuft \texttt{PuLP} standardmäßig auf der CPU, jedoch ermöglicht eine einfache Anpassung die Nutzung einer NVIDIA-GPU über CUDA \cite{gh-ilp-gpu}. Daher wurde das ILP-Modell sowohl auf der CPU als auch auf einer modernen GPU gelöst, um eine realistische Bewertung unter aktuellen technischen Voraussetzungen zu ermöglichen.
