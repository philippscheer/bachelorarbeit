...
In dieser Arbeit wird das SSP für einene einzelnen Studierenden des Hauptstudiums Wirtschaftsinformatik (inklusive CBK) betrachet und als ein Constaint-Satisfaction Problem (CSP) formuliert. Ziel ist eine möglichst akkurate Implementierung der Algorithmen, die Feldman \& Golumbic im Paper "Optimization Algorithms for Student Scheduling via Constraint Satisfiability" \cite{feldmangolumbic} beschreiben, um diese im Anschluss zu vergleichen.
...
\begin{enumerate}
    \item Validierung: Zentral ist die exakte Nachprogrammierung der Algorithmen von Feldman \& Golumbic \cite{feldmangolumbic}. Es soll überprüft werden, ob diese Algorithmen auch unter modernen Rechenbedingungen und mit realen Daten aus dem Vorlesungsverzeichnis der Wirtschaftsuniversität Wien einen optimalen Semesterplan erstellen können.
