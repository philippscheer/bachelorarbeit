...
BACHELORARBEIT_PATH = "/home/h12242922/bachelorarbeit"
PYTHON_PATH = "python"
...
class Tool(benchexec.tools.template.BaseTool):
    ...
    def executable(self):
        ...
        target_script = "models/hill_climbing_v3.py"
    ...
    def cmdline(self, executable, options, tasks, propertyfile=None, rlimits=None):
        ...
        return [PYTHON_PATH, executable] + tasks + options
    ...
    def determine_result(self, returncode, returnsignal, output, isTimeout):
        ...
        for line in output:
            if "SCHEDULE VALID" in line:
                return benchexec.result.RESULT_DONE  # Standard BenchExec green "Done"
            elif "SCHEDULE INVALID" in line:
                return "INVALID"  # You can return custom status strings too!
